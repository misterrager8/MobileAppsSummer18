...
import com.example.chemlleijoseph.summer18project.LoginActivity;
...
public class myMoviesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_my_movies, container, false);

        Button logInButton = v.findViewById(R.id.logInButton2);
